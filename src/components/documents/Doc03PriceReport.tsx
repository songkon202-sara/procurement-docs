  ...
  return (
    <div className="pg" data-doc-id="priceReport" style={{ display }}>
      ...
      <LetterheadMeta
        ...
        no={meta.no}
        date={meta.date}
        subject={`รายงานผลการจัดทำ${vm.cat.specBody} ราคากลางและหลักเกณฑ์การพิจารณาคัดเลือกข้อเสนอ สำหรับ ${vm.projectFull}`}
      />
      <div className="doc-body">
        ...
        <p>
          ตามบันทึก{data.org} ที่ {meta2.no} ลงวันที่ {meta2.date} ได้แต่งตั้งคณะกรรมการจัดทำ{vm.cat.specBody} และราคากลาง{' '}
          {vm.projectFull} วงเงินที่ได้รับจัดสรร {vm.amountDash} บาท ({vm.amountText}) ด้วยเงินบำรุง{data.org}
        </p>
        <p>
          บัดนี้ คณะกรรมการจัดทำ{vm.cat.specBody} ราคากลางและหลักเกณฑ์การพิจารณาคัดเลือกข้อเสนอ ได้กำหนดจัดทำ{vm.cat.specBody}{' '}
        ...
        <p>
          จึงเรียนมาเพื่อโปรดพิจารณา เห็นควรใช้{vm.cat.specBody} ราคากลางและหลักเกณฑ์การพิจารณาคัดเลือกข้อเสนอ
